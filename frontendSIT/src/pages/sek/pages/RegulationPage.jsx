...
export default function RegulationPage() {
  ...
  return (
    <PageShell
      ...
      description="Sekretaris & Ketua RT dapat membuat/mengubah Tata Tertib Warga Tetap dan Peraturan Tamu. Perubahan tercatat sebagai versi baru dan memicu notifikasi ke warga."
    >
